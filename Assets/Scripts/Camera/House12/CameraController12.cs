...
public class CameraController12 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (floor2)
        {
            ...
            if (upperLimit > 40.2f)
            {
                upperLimit = Mathf.Lerp(upperLimit, 40.2f, Time.deltaTime);
            }
            else upperLimit = 40.2f;
        }
        if (floor3)
        {
            if (bottomLimit < 54f)
            {
                bottomLimit = Mathf.Lerp(bottomLimit, 54f, Time.deltaTime);
            }
            else bottomLimit = 54f;
        }
        if (stairs1)
        {
        ...
        if (stairs2)
        {
            upperLimit = Mathf.Lerp(upperLimit, 60f, Time.deltaTime);
