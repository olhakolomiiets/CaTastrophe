...
public class CatInstantiator : MonoBehaviour
{
    ...
    [SerializeField] private Transform blackCat;
    ...
    private void CheckBrownCat()
    {
        if (PlayerPrefs.GetInt("brownfatcat") == 1 && PlayerPrefs.GetInt("brownfatcatPlace") == 0)
        {
            ...
            cat = Instantiate(catBrown, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
    ...
    private void CheckTigerCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(catTiger, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckBeigeCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(catBeige, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckGrayCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(catGrey, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckWhiteCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(catWhite, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckSlimCat ()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCat, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
     ...
     private void CheckSOSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCatSO, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckSSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCatS, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckRSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCatR, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckGSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCatG, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckDGSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCatDG, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void ChecBSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCatB, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void Check3BSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCat3B, new Vector3(Random.Range(60, 200), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
    ...
    private void CheckDSOSlimCat()
    {
        ...
        {
            placeForCat = FreePlaceInHouse();
            cat = Instantiate(slimCaDSO, new Vector3(Random.Range(-40, 30), placeForCat.catSpawnPositionY.transform.position.y, 0), Quaternion.identity);
            catScript = cat.GetComponent<HouseCat>();
            CopyPlaceParameters();
