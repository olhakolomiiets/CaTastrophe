...
namespace Samples.Purchasing.IAP5.Demo
{
    public class PaywallManager : MonoBehaviour
    {
        ...
        void InitCatalog()
        {
            ...
            const string extraLife = "com.catastrophepaid.extralife";
            const string moneyPack2000 = "com.catastrophepaid.moneypack2000";
            const string moneyPack5000 = "com.catastrophepaid.moneypack5k";
            const string moneyPack10000 = "com.catastrophepaid.moneypack10000";

            const string specialOfferMoneyPack7000 = "com.catastrophepaid.specialoffermoneypack7000";
            const string specialOfferMoneyPack3500 = "com.catastrophepaid.specialoffermoneypack3500";
            const string specialOfferStarterPack = "com.catastrophepaid.starterpack";
            const string extraLifeSpecial = "com.catastrophepaid.specialofferextralife";

            //const string k_IapSubscriptionAdventurePassSkuID = "com.unity.iap.test.adventure.pass";

            var initialProductsToFetch = new List<ProductDefinition>
            {
                new ProductDefinition(moneyPack2000, ProductType.Consumable),
                new ProductDefinition(moneyPack5000, ProductType.Consumable),
                new ProductDefinition(moneyPack10000, ProductType.Consumable),
                new ProductDefinition(specialOfferMoneyPack7000, ProductType.Consumable),
                new ProductDefinition(specialOfferMoneyPack3500, ProductType.Consumable),
                new ProductDefinition(specialOfferStarterPack, ProductType.Consumable),
                new ProductDefinition(extraLife, ProductType.NonConsumable),
                new ProductDefinition(extraLifeSpecial, ProductType.NonConsumable),
            };
